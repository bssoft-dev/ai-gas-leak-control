          ...
          {isSidebarCollapsed ? (
              ...
              <div className="h-full flex items-center justify-center px-[16px]">
                ...
                >
                  <img
                    ...
                    src={imgKeyboardDoubleArrowRightCollapsed}
                  />
                </button>
              </div>
            </div>
            ...
            <div className="h-[64px] bg-white border-b border-[var(--gray_sidebar_stroke,#e2e8f0)]">
              <div className="relative h-full px-[24px] pr-[84px] flex items-center">
                ...
                <button
                  type="button"
                  className="absolute right-[24px] top-1/2 flex h-5 w-5 shrink-0 -translate-y-1/2 items-center justify-center"
                  aria-label="사이드바 접기"
                ...
                >
                  <img
                    alt=""
                    className="block h-5 w-5 shrink-0 object-contain"
                    src={imgKeyboardDoubleArrowRight}
                  />
                </button>
              </div>
            </div>
