...
export class DefaultService {
     ...
     * @throws ApiError
     */
    public static getGasLeakEdgesApiGasLeakEdgesGet(): CancelablePromise<any> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/gas-leak/edges',
        });
    }
    /**
     * Get Gas Leak Available Sensors
     * 현재 데이터가 수신되고 있는 센서 ID 목록
     * @param edgeId
     * @returns any Successful Response
     * @throws ApiError
     */
    public static getGasLeakAvailableSensorsApiGasLeakAvailableSensorsGet(
        edgeId?: string,
    ): CancelablePromise<any> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/gas-leak/available-sensors',
            query: {
                'edge_id': edgeId,
            },
            errors: {
